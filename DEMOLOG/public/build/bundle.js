    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "#s");
    			add_location(a0, file, 67, 3, 1887);
    			attr_dev(div0, "id", "help-1");
    			attr_dev(div0, "class", "helpBoundary");
    			add_location(div0, file, 66, 2, 1844);
    			attr_dev(a1, "href", "#s");
    			add_location(a1, file, 78, 3, 2343);
    			attr_dev(div1, "id", "help-2");
    			attr_dev(div1, "class", "helpBoundary");
    			add_location(div1, file, 77, 2, 2300);
    			attr_dev(a2, "href", "#s");
    			add_location(a2, file, 88, 3, 2780);
    			attr_dev(div2, "id", "help-3");
    			attr_dev(div2, "class", "helpBoundary");
    			add_location(div2, file, 87, 2, 2737);
    			attr_dev(a3, "href", "#s");
    			add_location(a3, file, 98, 3, 3164);
    			attr_dev(div3, "id", "help-4");
    			attr_dev(div3, "class", "helpBoundary");
    			add_location(div3, file, 97, 2, 3121);
    			attr_dev(a4, "href", "#s");
    			add_location(a4, file, 108, 3, 3563);
    			attr_dev(div4, "id", "help-5");
    			attr_dev(div4, "class", "helpBoundary");
    			add_location(div4, file, 107, 2, 3520);
    			attr_dev(a5, "href", "#s");
    			add_location(a5, file, 117, 3, 3850);
    			attr_dev(div5, "id", "help-6");
    			attr_dev(div5, "class", "helpBoundary");
    			add_location(div5, file, 116, 2, 3807);
    			attr_dev(div6, "id", "help-box");
    			add_location(div6, file, 65, 1, 1783);
    		},
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			img = element("img");
    			add_location(br, file, 69, 76, 2053);
    			add_location(p0, file, 69, 3, 1980);
    			add_location(p1, file, 70, 3, 2066);
    			add_location(p2, file, 71, 3, 2116);
    			attr_dev(img, "id", "tut1");
    			if (img.src !== (img_src_value = "./img/Beastiary.gif")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "tut1");
    			add_location(img, file, 73, 3, 2212);
    			attr_dev(div, "class", "gifHolder");
    			add_location(div, file, 72, 3, 2146);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			img = element("img");
    			add_location(br, file, 80, 74, 2502);
    			add_location(p0, file, 80, 3, 2431);
    			add_location(p1, file, 81, 3, 2515);
    			attr_dev(img, "id", "tut2");
    			if (img.src !== (img_src_value = "./img/Vent.gif")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "tut2");
    			add_location(img, file, 83, 4, 2653);
    			add_location(div, file, 82, 3, 2604);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			append_dev(p0, t0);
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			img = element("img");
    			add_location(br, file, 90, 42, 2910);
    			add_location(p0, file, 90, 3, 2871);
    			add_location(p1, file, 91, 3, 2923);
    			attr_dev(img, "id", "tut3");
    			if (img.src !== (img_src_value = "./img/Records.gif")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "tut3");
    			add_location(img, file, 93, 4, 3034);
    			add_location(div, file, 92, 3, 2985);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			append_dev(p0, t0);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			img = element("img");
    			add_location(br, file, 100, 52, 3308);
    			add_location(p0, file, 100, 3, 3259);
    			add_location(p1, file, 101, 3, 3321);
    			attr_dev(img, "id", "tut4");
    			if (img.src !== (img_src_value = "./img/Progression.gif")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "tut4");
    			add_location(img, file, 103, 4, 3429);
    			add_location(div, file, 102, 3, 3380);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p0, anchor);
    			append_dev(p0, t0);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			img = element("img");
    			add_location(p, file, 119, 3, 3941);
    			attr_dev(img, "id", "tut6");
    			if (img.src !== (img_src_value = "")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "tut6");
    			add_location(img, file, 121, 4, 4020);
    			add_location(div, file, 120, 3, 3971);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 62, 5, 1682);
    			add_location(p0, file, 62, 2, 1679);
    			attr_dev(div0, "id", "help");
    			add_location(div0, file, 61, 2, 1660);
    			attr_dev(img, "id", "appIcon");
    			if (img.src !== (img_src_value = "./img/UI/composition.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "appIcon");
    			add_location(img, file, 132, 2, 4159);
    			add_location(br0, file, 133, 2, 4227);
    			attr_dev(span0, "id", "appTitleFont");
    			add_location(span0, file, 134, 2, 4235);
    			attr_dev(p1, "class", "select-container");
    			add_location(p1, file, 128, 2, 4116);
    			attr_dev(div1, "class", "COF-wheel");
    			add_location(div1, file, 60, 2, 1633);
    			attr_dev(span1, "class", "description-header");
    			add_location(span1, file, 141, 4, 4377);
    			add_location(br1, file, 143, 155, 4585);
    			add_location(br2, file, 144, 160, 4751);
    			attr_dev(a0, "id", "pingSource");
    			attr_dev(a0, "href", "#");
    			add_location(a0, file, 145, 18, 4775);
    			add_location(p2, file, 143, 4, 4434);
    			add_location(br3, file, 150, 4, 5016);
    			attr_dev(span2, "class", "description-header");
    			add_location(span2, file, 151, 4, 5026);
    			add_location(br4, file, 152, 65, 5145);
    			add_location(br5, file, 153, 55, 5206);
    			add_location(br6, file, 154, 72, 5284);
    			add_location(br7, file, 155, 106, 5396);
    			add_location(p3, file, 152, 5, 5085);
    			add_location(br8, file, 158, 5, 5501);
    			attr_dev(span3, "class", "description-header");
    			add_location(span3, file, 159, 4, 5511);
    			add_location(br9, file, 160, 118, 5708);
    			add_location(br10, file, 161, 173, 5887);
    			add_location(p4, file, 160, 5, 5595);
    			add_location(br11, file, 164, 4, 5987);
    			add_location(span4, file, 165, 5, 5998);
    			add_location(br12, file, 166, 39, 6057);
    			add_location(p5, file, 166, 5, 6023);
    			attr_dev(div2, "class", "introBox");
    			add_location(div2, file, 140, 3, 4349);
    			attr_dev(div3, "class", "song-detail");
    			add_location(div3, file, 139, 2, 4319);
    			attr_dev(div4, "class", "mini-container");
    			add_location(div4, file, 59, 1, 1601);
    			attr_dev(div5, "class", "container");
    			add_location(div5, file, 58, 0, 1575);
    			attr_dev(span5, "id", "home");
    			add_location(span5, file, 177, 2, 6203);
    			add_location(br13, file, 178, 2, 6267);
    			attr_dev(a1, "href", "https://github.com/5v1n0");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file, 179, 16, 6289);
    			add_location(p6, file, 179, 2, 6275);
    			add_location(footer, file, 176, 1, 6191);
    		},
